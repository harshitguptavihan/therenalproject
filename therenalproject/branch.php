...
<br>
 ...
 <!-- Trigger the modal with a button -->
  <button type="button" class="col-sm-offset-10 btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Create Branch</button>
<br>
<br>
<br>
<br>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <center>   <h4 class="modal-title">Create a new Branch</h4></center>
        </div>
  ...
  <div class="form-group col-sm-6">
	...
	<div class="row">
    <div class="form-group col-sm-6">
      <label for="amt">Amount Per Patient:</label>
      <input type="number" class="form-control" id="email" placeholder="Enter Amount Per Patient" name="amt" class="col-sm-3" required>
    </div>
	</div>
