...
<br>
 ...
 <!-- Trigger the modal with a button -->
  <button type="button" class="col-sm-offset-10 btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Create Staff</button>
<br>
<br>
<br>
<br>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <center>   <h4 class="modal-title">Create a new Staff</h4></center>
        </div>
